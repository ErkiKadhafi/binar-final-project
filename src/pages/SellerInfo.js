  ...
  return (
    <>
      ...
      >
        ...
        <div className="rounded-2xl p-4 flex flex-col shadow-low mb-6 bg-neutral-neutral02">
          <h1 className="text-sm text-center font-medium">Product Match</h1>
          <div className="flex space-x-4 mt-4">
            ...
            <div className="flex flex-col space-y-1">
              <h3 className="font-medium mb-1 text-sm">Nama Pembeli</h3>
              <h3 className="text-neutral-neutral03 text-xs">Kota</h3>
            </div>
          </div>
          <div className="flex space-x-4 mt-4">
            <img
      ...
      >
        ...
        <div className="p-4 flex flex-col space-x-4 mb-6">
          <div className="flex flex-box mt-4">
            ...
            <div className="flex flex-col space-y-1">
              <h3 className="font-medium mb-1 text-sm">Berhasil terjual</h3>
          ...
          <div className="flex flex-box mt-4">
            ...
            <div className="flex flex-col space-y-1">
              <h3 className="font-medium mb-1 text-sm">Batalkan transaksi</h3>
              <h3 className="text-neutral-neutral03 text-sm">
      ...
      <section className="font-poppins pt-5 md:pt-114px">
        <div className="container-small relative">
          ...
          <div className="p-4 shadow-low rounded-2xl flex items-center space-x-4 bg-white">
            ...
            <div className="">
              <h1 className="font-medium mb-1 text-sm">Nama Pembeli</h1>
              <h2 className="text-neutral-neutral03 text-xs">Kota</h2>
            </div>
          </div>
          <h2 className="mt-6 font-medium mb-1 text-sm">
            Daftar Produkmu yang Ditawar
          </h2>
          <div className="border-b mt-6 p-4 flex space-x-4 bg-white">
            <div>
              <img
                src="/images/watch-small.png"
                alt="watch"
            ...
            <div className="w-full">
              <div className="flex flex-box justify-between">
                ...
                <h2 className="text-neutral-neutral03 text-xs">20 Apr,14:04</h2>
              </div>
              <h2 className="font-medium mb-13 text-sm">Jam Tangan Casio</h2>
              <h2 className="font-medium mb-13 text-sm">Rp.250.000</h2>
              <h2 className="font-medium mb-13 text-sm">Ditawar Rp.200.000</h2>
              <div className="flex items-center justify-end space-x-4 mt-4">
                <Button variant="secondary" className="rounded-full w-32 h-0">
                  Tolak
                </Button>
                <Button
                  onClick={() => setModalOpen(true)}
                  className="rounded-full w-32 h-0"
                >
                  Terima
                </Button>
              </div>
